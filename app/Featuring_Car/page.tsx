...
export default function Featuring_Car(){
    return(
        <div className="bg-[#F6F7F9] flex flex-row relative">
            <SideBar />

            <div className="absolute left-[392px] top-[32px] w-[492px]  h-[360px] bg-gradient-to-r from-[#3563E9] to-[#3563E980] ">
...
<Image src={'image 8.svg'} alt="Car" width={340} height={116} className="absolute top-[234px] left-[147px]" />
                </div>
                ...
                <div className="absolute w-[492px] h-[508px] top-[32px] left-[916px] rounded-[10px] border-2">
                    <div className="relative w-[220px] h-[72px] top-[24px] left-[24px] gap-[8px]">
                        <h1 className="font-[700] text-[32px]">Nissan GT - R</h1>
                        <Image src={'/Reviews.svg'} alt="Reviews" width={220} height={240} />
                    </div>
                        <div className="absolute w-[24px] h-[24px] top-[24px] left-[444px]">
                        <Heart className="fill-[#ED3F3F] text-[#ED3F3F]" />
                        </div>
                        
                        <div className="absolute w-[444px] h-[120px] top-[128px] left-[24px]">
                            <h2 className="font-[400] text-[20px] text-[#596780]">NISMO has become the embodiment of Nissan's outstanding performance, inspired by the most unforgiving proving ground, the "race track".</h2>
                             </div>
                             <Image src={'/Spesification.svg'} alt="Specs" width={444} height={72} className="absolute top-[280px] left-[24px]" />
                             <Image src={'/price.svg'} alt="Price" width={200} height={56} className="absolute top-[420px] left-[24px]" />
                ...
                <Image src={'/View 1.svg'} alt="view1" width={148} height={124} className="absolute top-[416px] left-[392px] rounded-[8px]" />
                <Image src={'/View 2.svg'} alt="view2" width={148} height={124} className="absolute top-[416px] left-[564px] rounded-[10px]" />
                <Image src={'/View 3.svg'} alt="view3" width={148} height={124} className="absolute top-[416px] left-[736px] rounded-[8px]" />

                <div className="absolute w-[1016px] h-[452px] top-[572px] left-[392px] rounded-[10px]">
                    <Image src={'/Total Review.svg'} alt="total-rew" width={136} height={28} className="relative top-[24px] left-[24px] gap-[12px]" />
                    <Image src={'/Reviews 1.svg'} alt="Rew1" width={968} height={124} className="relative top-[84px] left-[24px] gap-[12px]" />
                    <Image src={'/Reviews 2.svg'} alt="Rew1" width={968} height={124} className="absolute top-[240px] left-[24px] gap-[12px]" />
                    <Image src={'/Show All.svg'} alt="Show All" width={132} height={44} className="absolute top-[384px] left-[454px] gap-[12px] cursor-pointer" />

                     </div>

                     <Image src={'/Recent Car.svg'} alt="RecentCars" width={1016} height={448} className="absolute top-[1056px] left-[392px]" />
